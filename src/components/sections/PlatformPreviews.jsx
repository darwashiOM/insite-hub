const PREVIEWS = [
  ...
  { c: "#75abc0", name: "Proxa Labs Atlas", sub: "Rep pathway dashboard",
    rows: [
      ...
      { label: "Echo readiness threshold",       pct: 90,  c: "#9ca979", bg: "rgba(156,169,121,.12)" },
    ],
    status: "Echo assessment unlocked" },
  { c: "#5e6b7a", name: "Proxa Labs Echo", sub: "HCP roleplay session · Dr. Kim",
    rows: [
  ...
  { c: "#9ca979", name: "Certify", sub: "Certification audit record",
    rows: [
