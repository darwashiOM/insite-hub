...
const LoopMobile = () => {
  ...
  const nodes=[
    {label:"Forge",sub:"Builds content",icon:"⚡",c:"#F4801F",bg:"rgba(244,128,31,.06)",
     desc:"AI agents generating MLR-compliant content from your PI, CSRs, and brand assets."},
    {label:"Atlas",sub:"Delivers learning",icon:"🎓",c:"#007AFF",bg:"rgba(0,122,255,.06)",
     desc:"Adaptive learning pathways closing knowledge gaps before reps reach the field."},
    {label:"Echo",sub:"Assesses readiness",icon:"🎭",c:"#7C3AED",bg:"rgba(124,58,237,.06)",
     desc:"Live HCP roleplay with AI physician avatars. Real-time ComplianceGuard monitoring."},
    {label:"Certify",sub:"Confirms competency",icon:"✅",c:"#059669",bg:"rgba(5,150,105,.06)",
            ...
            <div key={n.label}>
              <div onClick={()=>setActive(i)} style={{
                ...
                <div style={{
                  ...
                  display:"flex",alignItems:"center",justifyContent:"center",fontSize:isAct?24:18,
                  transition:"all .3s",
