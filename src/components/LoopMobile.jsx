...
const LoopMobile = () => {
  ...
  const nodes=[
    ...
    {label:"Cue",sub:"Delivers learning",iconName:"pathway",c:"#9ca979",bg:"rgba(156,169,121,.06)",
    ...
    {label:"Trace",sub:"Confirms competency",iconName:"audit",c:"#75abc0",bg:"rgba(117,171,192,.06)",
