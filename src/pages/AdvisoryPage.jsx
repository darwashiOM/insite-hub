      ...
      <div className="mw">
        <div className="grid-2" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:64,alignItems:"start"}}>
          ...
          <div style={{background:"var(--lt)",borderRadius:18,padding:30}}>
            ...
            {[
              {t:"No path from pilot to production",d:"Pilots are designed to succeed in controlled conditions. Production deployment is a governance, IT validation, and change management challenge. Most pilots were never designed to survive that moment."},
              {t:"Weak data foundations",d:"The AI works in the demo. It fails when introduced to your actual content architecture — legacy systems, approved materials in formats AI can't reliably process, no structured pipelines between LMS and CRM."},
              {t:"Misaligned ownership",d:"The pilot was owned by L&D or IT, not a commercial business leader with revenue accountability. Without a sponsor, it stalls at the governance gate and dies quietly in a committee meeting."},
              {t:"Measurement theater",d:"Engagement metrics that can't show a line to commercial performance. When the CCO asks 'what did this do for revenue?' the answer is a learning maturity framework. Projects that can't answer that question get cut."},
            ].map((f,i)=>(
